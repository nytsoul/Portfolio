...
export default function About() {
  const stats = [
    ...
    { title: "Projects", value: "30+", unit: "Completed", icon: Code, accent: "text-chart-2" },
    { title: "CP Problems", value: "300+", unit: "Solved", icon: Trophy, accent: "text-chart-3" },
  ...
  const timeline = [
    { year: "2023", event: "Enrolled — SSN College of Engineering, Chennai" },
    { year: "2023", event: "Began competitive programming on Codeforces" },
    { year: "2024", event: "Shipped first full-stack production application" },
    { year: "2024", event: "Entered cybersecurity & penetration testing" },
